...
/**
 * Cookie banner GDPR minimale per il sito cliente.
 * Usa SOLO classi/variabili della palette dinamica (--color-accent / --color-ink)
 * così si integra automaticamente con qualsiasi tema generato dall'AI.
 *
 * Per default i siti generati NON usano analytics di terze parti — il banner
 * è informativo + permette opt-in futuro (es. quando il cliente attiva GA4
 * tramite l'addon "analytics").
 */
