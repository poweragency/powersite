  ...
  return (
    <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-[2fr_1fr]">
      ...
      <form id={FORM_ID} onSubmit={handleSubmit} className="space-y-16">
        ...
        {/* ─── II. CONTATTI ──────────────────────────────── */}
        <section>
          <SectionHeader n="II" title="I tuoi contatti" />
        ...
        {/* ─── III. BRIEF ────────────────────────────────── */}
        <section>
          <SectionHeader n="III" title="Il tuo brand" />
        ...
        {/* ─── IV. IMMAGINI ──────────────────────────────── */}
        <section>
          <SectionHeader n="IV" title="Le tue foto" hint={`${images.length}/30`} />
        ...
        {/* ─── V. ADDONS ─────────────────────────────────── */}
        <section>
          <SectionHeader n="V" title="Add-on" hint={`${addons.length} selezionati`} />
