        ...
        <form ref={formRef} id={FORM_ID} onSubmit={handleSubmit}>
          ...
          */}
          ...
          <div className={step === 2 ? "space-y-16" : "hidden"}>
              ...
              {/* ─── Banner: nessun pagamento in questa fase ─── */}
              <div className="flex items-start gap-4 rounded-2xl border border-brass/30 bg-brass/5 p-5">
                <span className="grid h-10 w-10 flex-none place-items-center rounded-full border border-brass/40 bg-brass/15 text-brass">
                ...
                <div>
                  <p className="text-sm font-semibold text-cream">In questa fase non paghi nulla.</p>
                  <p className="mt-1 text-xs leading-relaxed text-mist">
                    Scegli soltanto la configurazione del tuo sito. Costruiamo l&apos;anteprima e te la
                    mostriamo <strong className="text-bone">gratis</strong>: il canone mensile parte solo se decidi di tenerlo.
                  </p>
                </div>
              </div>
